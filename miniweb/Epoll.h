...
public:
  ...
  static int epoll_add(int fd, std::shared_ptr<requestData> request, _uint32_t events);
  static int epoll_mod(int fd, std::shared_ptr<requestData>, _uint32_t events);
  static int epoll_del(int fd, _uint32_t events);
